...
//const int nPoints = 1000 + 1 + 1; //exercicio 6 - c, d
//const int nPoints = 8 + 1 + 1; //exercicio a
//const int nPoints = 5 + 1 + 1; //exercicio b
const int nPoints = 10 + 1 + 1; //exercicio e
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lista 1, Exercício 6 - Lucas Schneider", nullptr, nullptr);
