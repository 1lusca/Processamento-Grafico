...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lucas Schneider - Lista 2 - Exercicio 5", nullptr, nullptr);
...
int setupGeometry()
{
	GLfloat vertices[] = {
		//x					y					z		r		g		b	
		-0.5 * 100 + 400, 	0.5 * 100 + 300, 	0.0, 	0.451, 	0.769, 0.949, //v0
		0.5 * 100 + 400, 	0.5 * 100 + 300, 	0.0, 	0.451, 	0.769, 0.949, //v1
		0.0 * 100 + 400, 	-0.5 * 100 + 300,  	0.0, 	0.451, 	0.769, 0.949  //v2
