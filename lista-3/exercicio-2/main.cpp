...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lucas Schneider - Lista 3 - Exercicio 2", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model2 = glm::scale(model2, glm::vec3(300.0, 300.0, 1.0));
		...
		model3 = glm::scale(model3, glm::vec3(300.0, 300.0, 1.0));
		...
		model4 = glm::translate(model4, glm::vec3(400.0, 300.0, 0.0));
		model4 = glm::scale(model4, glm::vec3(300.0, 300.0, 1.0));
		GLint modelLoc4 = glGetUniformLocation(shader.ID, "model");
		glUniformMatrix4fv(modelLoc4, 1, false, glm::value_ptr(model4));
...
// 								y
	...
	// GLfloat vertices[] = {
	// 	//x   y     z    r    g    b
	// 	-0.5 , -0.5 , 0.0, 0.451, 	0.769, 	0.949, //v0
	// 	 0.5 , -0.5 , 0.0, 0.451, 	0.769, 	0.949, //v1
	// 	 0.0 , 0.5 ,  0.0, 0.451, 	0.769, 	0.949  //v2
	// };
